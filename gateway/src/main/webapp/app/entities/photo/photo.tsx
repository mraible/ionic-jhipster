...
export const Photo = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const photoList = useAppSelector(state => state.flickr2.photo.entities);
  const loading = useAppSelector(state => state.flickr2.photo.loading);
  const totalItems = useAppSelector(state => state.flickr2.photo.totalItems);
  const links = useAppSelector(state => state.flickr2.photo.links);
  const entity = useAppSelector(state => state.flickr2.photo.entity);
